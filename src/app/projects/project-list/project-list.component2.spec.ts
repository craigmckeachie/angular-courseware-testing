...
describe("ProjectListComponent", () => {
  ...
  it("should instantiate component", () => {
    expect(component instanceof ProjectListComponent).toBe(
      true,
  ...
  it(
    ...
    async(() => {
      fixture.detectChanges(); // causes OnInit to run
      // wait for async list method on service
      fixture.whenStable().then(() => {
        // update view with projects from service
